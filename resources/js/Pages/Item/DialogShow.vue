          ...
          <v-row>
            <v-col cols="12" md="6" class="py-1">
              <p class="mb-2 text-sm text-gray-700">
                <strong class="text-gray-900">Kode Item:</strong> {{ item.kode }}
              </p>
              <p class="mb-2 text-sm text-gray-700">
                <strong class="text-gray-900">Nama Item:</strong> {{ item.nama }}
              </p>
              <p class="mb-2 text-sm text-gray-700">
                <strong class="text-gray-900">Harga:</strong> Rp {{ formatNumber(item.harga) }}
              </p>
            </v-col>
            <v-col cols="12" md="6" class="py-1">
              <v-img
                ...
                class="rounded-lg"
              />
              <span v-else class="text-sm text-gray-500">Tidak ada gambar</span>
            </v-col>
          </v-row>
        </div>
      </v-card-text>
