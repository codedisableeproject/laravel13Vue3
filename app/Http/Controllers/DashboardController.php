...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Widgets
        $jumlahTransaksi = Penjualan::whereBetween('tanggal_penjualan', [$startDate, $endDate])->count();
        $jumlahPenjualan = Penjualan::whereBetween('tanggal_penjualan', [$startDate, $endDate])->sum('total');
